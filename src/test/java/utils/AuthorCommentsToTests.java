...
public class AuthorCommentsToTests {
    ...
    public static String COMMENT_1 = "I presume we have an API design validation issue here:" +
    ...
    public static String COMMENT_2 = "I presume we have an API design  issue here: " +
    ...
    public static String COMMENT_3 = "I presume we have an API design  issue here: " +
            " AssignLicenseRequest body schema validation" +
